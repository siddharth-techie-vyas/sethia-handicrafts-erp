...
if($items){
        ...
        <tr>
            ...
            <td>
                <input type="hidden" name="amount[]" id="amount<?php echo $counter;?>" value="<?php echo $price;?>">
        ...
        <tr>
            <th colspan="6">
                <form name="step0_edit" id="step00_edit" action="<?php echo $base_url.'index.php?action=sales&query=rfq_step4_edit'?>" method="post">
                    <input type="hidden" name="sid" value="<?php echo $_GET['id'];?>">     
                    <input type="submit" name="step5" value="Submit to Step 5" class="btn btn-warning btn-md">     
                </form>
            </th>
            <th colspan="6"></th>
        </tr>
