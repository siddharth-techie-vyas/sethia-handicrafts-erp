   	 ...
   	 */
		...
		_createClass(Lightbox, [{
			...
			value: function _showYoutubeVideo(remote, $containerForElement) {
				...
				return this._showVideoIframe('../../../../../wwwyoutubecom/embed/index_7864369.html' + id + '?badge=0&autoplay=1&html5=1' + query, width, height, $containerForElement);
			}
		}, {
			key: '_showVimeoVideo',
			...
			value: function _showInstagramVideo(id, $containerForElement) {
				...
				$containerForElement.html('<iframe width="' + width + '" height="' + height + '" src="' + id + 'embed/index_3342452.html" frameborder="0" allowfullscreen></iframe>');
